# Generated by Powerlevel10k configuration wizard on 2022-07-02 at 15:03 MSK.
...
# dotted, right frame, dark-ornaments, sparse, many icons, concise, transient_prompt,
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=false
  # Custom icon.
